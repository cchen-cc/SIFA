...
CHECKPOINT_PATH = './output/20190718-215157/sifa-9299'
KEEP_RATE = 1.0
IS_TRAINING = False

raw_size = [256, 256, 1] # original raw input size
volume_size = [256, 256, 1] # volume size after processing
...
class SIFA:
    ...
    def __init__(self, config):
        ...
        self.test_fid = self.base_fd + "/npz_ct_test_5cls"
        ...
        with tf.Session() as sess:
            ...
            for idx_file, fid in enumerate(test_list):
                ...
                for ii in range(int(np.floor(data.shape[2] // self.batch_size))):
                    data_batch = np.zeros([self.batch_size, raw_size[0], raw_size[1], raw_size[2]])
